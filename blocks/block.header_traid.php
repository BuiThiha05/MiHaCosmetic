            ...
            <div class="box-inner">
                ...
                <div class="box-inner-inner">
                    ...
                    <div class="col-logo">
                        ...
                        <style>
                            ...
                            #pt-menu-9311 .ul-top-items .li-top-item > a > span:after {
                                background: #83BC2E;
                            }
                                    ...
                                    if ($web_menu->parent == 0) {
                                        ...
                                        <li class="li-top-item ">
                                            ...
                                            <a class="a-top-link a-item"
                                               href="<?= $ariacms->actual_link . $web_menu->url_html ?>">
                ...
                <i class="ion-ios-arrow-up" aria-hidden="true"></i>
                                                        ...
                                                        <?php foreach ($web_menus as $key1 => $sub_menu) {
                                                            ...
                                                            if ($web_menu->id == $sub_menu->parent and $sub_menu->parent > 0) { ?>
                                                                ...
                                                                <li class="li-second-items">
                                                                    ...
                                                                    <a href="<?= $ariacms->actual_link . $sub_menu->url_html ?>"
                        ...
                        <div id="logo">
                            ...
                            <a href="<?= $ariacms->actual_link ?>"><img
                                        src="<?= $ariacms->web_information->{'image-logo'} ?>" title="" alt=""
                    ...
                    <div class="col-hoz">
                        ...
                        <style>
                            ...
                            #pt-menu-9461 .ul-top-items .li-top-item > a > span:after {
                                background: #83BC2E;
                            }
                        ...
                        <div class="inner">
                            ...
                            <div id="search-by-category">
                                ...
                                <div class="dropdown-menu search-content">
                                    ...
                                    <form class="navbar-form" role="search" method="POST" id="searchform"
                                          action="<?= $ariacms->actual_link ?>/san-pham.html">
                                        ...
                                        <div class="search-container">
                                            ...
                                            <input type="text" name="key" id="text-search" value="<?= $_POST["key"] ?>"
                                                   placeholder="<?= _SEARCH ?>" class=""/>
                                            ...
                                            <div class="search-ajax">
                                                ...
                                                <div class="ajax-loader-container" style="display: none;">
                                                    ...
                                                    <img src="/templates/traid/timage/catalog/ajax-loader.gif"
                                                         alt="search-ajax" class="ajax-load-img" width="30"
                                                         height="30"/>
                            ...
                            <a href="<?= $ariacms->actual_link ?>yeu-thich.html" id="wishlist-total"><span><span
                                            class="text-wishlist"><?= _WISHLIST ?></span> <span
                                            class="txt-count"><?= $j ?></span></span></a>
                            ...
                            <div id="cart" class="btn-group btn-block">
                                ...
                                <button type="button" data-toggle="dropdown" data-loading-text="Loading..."
                                        class="btn btn-inverse btn-block btn-lg dropdown-toggle"><span
                                            id="cart-total"><span class="txt-count"><?= $i ?></span><span
                                                class="text-item"> <?= _YOUR_CART ?> </span><span
                                                class="text-cart"><?= $total ?> VNĐ</span></span></button>
                                ...
                                <?php if ($i == 0) { ?>
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        <li>
                                            ...
                                            <span class="cart-dropdown-menu-close"><i
                                            ...
                                            <?php foreach ($products as $product) { ?>
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center cart-image"><a
                                                                    href="<?= $ariacms->actual_link ?>chi-tiet/<?= $product->url_part ?>.html"><img
                                                                        width="80" height="80"
                                                                        src="<?= $product->image ?>"
                                                                        alt="Pellentesque sodales"
                                                                        title="Pellentesque sodales"
                                                        ...
                                                        <td class="text-left cart-info">
                                                            ...
                                                            <p>
                                                                ...
                                                                <strong>Eco Tax:</strong> <?= $product->Eco_tax ?>
                                                                VNĐ/<?= _PRODUCT ?>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button"
                                                                    ...
                                                                    title="Remove"
                                                                    class="btn btn-danger btn-xs button-cart-remove"><i
            ...
            <tr>
              ...
              <td class="text-right"><?= $product->VAT ?>%</td>
                                                ...
                                                <p class="text-right"><a
                                                            href="<?= $ariacms->actual_link ?>gio-hang.html"><strong><i
                                                                    class="fa fa-shopping-cart"></i><?= _VIEW_CART ?>
                                                        </strong></a><a
                                                            href="<?= $ariacms->actual_link ?>giao-hang.html"><strong><i
                                                                    class="fa fa-share"></i><?= _CHECKOUT ?>
                                                        </strong></a></p>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="language">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data"
                                                  id="form-language" class="header-dropdown">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn btn-link dropdown-toggle" data-toggle="dropdown">
                                                        ...
                                                        <span class="hidden-xs"><?= _LANGUAGE ?></span>&nbsp;<i
                                                                class="icon-right ion-ios-arrow-down"></i></button>
                                                        ...
                                                        <?php if ($_SESSION['steam_lang'] == 'vi') { ?>
                                                            ...
                                                            <li>
                                                                ...
                                                                <button class="btn btn-link btn-block language-select"
                                                                        type="submit"
                                                                        onclick="change_Lang('<?= $_SESSION['steam_lang'] ?>')"
                                                                        href="/"><img
                                                                            src="/templates/traid/catalog/language/en-gb/en-gb.png"
                                                                            alt="English"
                                                                            title="English"/><?= _ENGLISH ?></button>
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <li>
                                                                ...
                                                                <button class="btn btn-link btn-block language-select"
                                                                        ...
                                                                        onclick="change_Lang('<?= $_SESSION['steam_lang'] ?>')"
                                                                        href="/"><img
                                                                            src="/templates/traid/catalog/language/vi/vietnam.jpg"
                                                                            alt="Vietnamese"
                                                                            title="Vietnamese"/><?= _VIETNAMESE ?>
                                                                </button>
                                        ...
                                        <li id="top-links" class="nav header-dropdown">
                                            ...
                                            <ul class="list-inline">
                                                ...
                                                <li class="dropdown"><a href="<?= $ariacms->actual_link ?>/account.html"
                                                                        title="My Account" data-toggle="dropdown"><i
                                                                class="ion-android-person icons"></i> <span
                                                                class="hidden-xs"><?= _ACCOUNT ?></span></a>

                                                    <ul class="pt-account">

                                                        <?php if ($_SESSION['member']) { ?>

                                                            <li><a href="<?php echo $ariacms->actual_link . 'member.html'; ?>"><?php echo $_SESSION['member']['fullname'] ?></a>
                                                            </li>

                                                            <li>
                                                                <a href="<?php echo $ariacms->actual_link . 'register/logout.html'; ?>"><?= _SIGN_OUT ?></a>
                                                            </li>

                                                        <?php } else { ?>

                                                            <li><a id="pt-register-link"
                                                                   href="<?= $ariacms->actual_link ?>/register.html"><?= _REGISTER ?></a>
                                                            </li>

                                                            <li><a id="pt-login-link"
                                                                   href="<?= $ariacms->actual_link ?>/register.html"><?= _SIGN_IN ?></a>
                                                            </li>
