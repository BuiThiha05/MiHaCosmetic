					...
					<form method="post" action="index.php?module=cart&task=cart_edit&id=<?= $detail['id'] ?>">
						...
						<div class="form-group">
							...
							<select id="status" name="status" class="form-control">
								...
								<option <?= ($detail['status'] == 'ondelivery') ? 'selected' : ''; ?> value="ondelivery">Đang giao hàng</option>
								<option <?= ($detail['status'] == 'delivery') ? 'selected' : ''; ?> value="delivery" disabled >Đã nhận hàng</option>
								<option <?= ($detail['status'] == 'nodelivery') ? 'selected' : ''; ?> value="nodelivery" disabled >Chưa nhận hàng</option>
