    ...
    static function viewhome()
    {
        ...
        <head>
            ...
            <link href="/templates/traid/catalog/view/javascript/font-awesome/css/font-awesome.min.css" rel="stylesheet"
                  type="text/css"/>
            <link href="/templates/traid/catalog/view/javascript/ionicons/css/ionicons.css" rel="stylesheet"
                  type="text/css"/>
            <!-- end icon font -->
            <!-- end -->
            <link href="/templates/traid/catalog/view/theme/tt_amino1/stylesheet/stylesheet.css" rel="stylesheet">
            <link href="/templates/traid/catalog/view/theme/tt_amino1/stylesheet/plaza/header/header1.css"
                  rel="stylesheet">
            ...
            <link href="/templates/traid/catalog/view/theme/tt_amino1/stylesheet/plaza/quickview/quickview.css"
                        ...
                        <form name="checkout" method="post" class="checkout woocommerce-checkout" action="#"
                            ...
                            <fieldset id="account" style="width: 740px;">
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="fullname" placeholder="<?= _FULLNAME ?>" id="fullname"
                                               class="form-control" value="<?= $_SESSION['member']['fullname']?>"/>
                                    </div>
                                </div>
                                <div class="form-group required">
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" name="email" placeholder="<?= _EMAIL ?>" id="email"
                                               class="form-control" value="<?= $_SESSION['member']['email']?>"/>
                                    </div>
                                </div>
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-telephone"><?= _PHONE ?></label>
                                    <div class="col-sm-10">
                                        <input type="tel" name="phone" placeholder="<?= _PHONE ?>" id="phone"
                                               class="form-control" value="<?= $_SESSION['member']['homephone']?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
										<textarea name="content" id="phone" class="form-control" id="order_comments"
                                                  rows="3" cols="5">
										</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 col-sm-offset-8">
                                    ...
                                    <div id="payment" class="woocommerce-checkout-payment">
                                        ...
                                        <div class="form-row place-order">
                                            ...
                                            <button type="submit" class="button alt" name="btnSubmit" id="place_order"
                                                    value="Place order"
                                                    data-value="Place order"><?= _PLACE_ORDER ?></button>
