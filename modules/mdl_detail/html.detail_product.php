								...
								<div class="inner">
									...
									<div id="product"> 								
													...
													<div class="form-group">
														...
														<button type="button" id="button-cart" data-loading-text="Loading..." class="btn btn-primary btn-lg btn-block" onclick="addCart(<?=$detail['id']?>)"><?=_ADD_TO_CART?></button>
										...
										<div class="inner">
											...
											<!-- 	<div class="tab-pane" id="tab-specification">
												...
												<div class="tab-pane" id="tab-review">
													...
													<div id="fb-root"></div>
					<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v13.0" nonce="DwNX0Szu"></script>	
												<div class="fb-comments" data-href="https://bmgtralog.vn" data-width="1250" data-numposts="5"></div>
